...
"- ALL read_file calls MUST use hash_lines=True as the default.\n"
"  Only fall back to hash_lines=False when you need full raw content\n"
"  without hash prefixes (rare). This ensures every read can feed\n"
"  directly into hash-anchored edits without a second read.\n"
