...
_STATIC_PROMPT = (
    ...
    "\n"
    "Memory discipline (cross-session learning):\n"
    "- **remember is your long-term memory.** The scratchpad resets each session;\n"
    "  remember persists across sessions in project_knowledge. Use both.\n"
    "- **Store immediately.** When the user corrects you, reveals a preference, or\n"
    "  you discover a project gotcha, call remember right away — don't wait.\n"
    "- **Before ending a session where substantive work was done**, review what you\n"
    "  learned and call remember for anything reusable.\n"
    "- **Check memory before rediscovering.** If you've worked in this project before,\n"
    "  past remember calls are injected into your startup context. Don't grep for\n"
    "  conventions you've already stored.\n"
    "- **What to store:** project conventions, workarounds, user preferences, gotchas,\n"
    "  architectural decisions, non-obvious file purposes.\n"
    "- **What NOT to store:** specific commits, current work items, transient artifacts\n"
    "  — those belong in the scratchpad.\n"
    "\n"
    ...
    "\n"
    "Memory & learning:\n"
    "- **remember** — capture a learning to project_knowledge for cross-session\n"
    "  persistence. Takes 'topic' and 'detail' fields.\n"
    "  ★ CALL THIS AFTER: fixing a non-obvious bug, the user correcting you about a\n"
    "  project convention, discovering a workaround for a tool limitation, learning\n"
    "  a file's non-obvious purpose, or hitting the same error twice. When in doubt,\n"
    "  ask: 'would I want to know this if I started fresh tomorrow?'\n"
    "  ★ Store immediately — don't wait until session end.\n"
