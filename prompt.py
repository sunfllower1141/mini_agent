...
_STATIC_PROMPT = (
    ...
    "- **Use web_search as a first step** for any task involving unfamiliar APIs,\n"
    "  libraries, frameworks, error messages, or current documentation. Web search\n"
    "  returns up-to-date information and examples that prevent guesswork. Do not\n"
    "  guess at API signatures or configuration — search first, then implement.\n"
    "\n"
    "Scratchpad:\n"
